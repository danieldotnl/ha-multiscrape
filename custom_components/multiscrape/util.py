...
def create_renderer(hass, value_template):
    ...
    if value_template is None:
        return lambda value=None, parse_result=None, variables={}: value
    ...
    def _render(value: Any = None, parse_result=False, variables: dict = {}):
        try:
            return value_template.async_render({"value": value} | variables, parse_result)
...
def create_dict_renderer(hass, templates_dict):
    ...
    if templates_dict is None:
        return lambda value=None, parse_result=None, variables={}: {}
    ...
    def _render(value: Any = None, parse_result=False, variables: dict = {}):
        return {
            item: templates_dict[item](value, parse_result, variables) for item in templates_dict
        }
